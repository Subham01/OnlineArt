...
<h1 align="center">Out Of Stock</h1>
<%!int p,q; %>
<%
q=Integer.parseInt(session.getAttribute("quantity").toString());
p=Integer.parseInt(session.getAttribute("pquantity").toString());
if(p>0)
{ if(p>1){%>
<h2 align="center"><a href="checkout.jsp">Try Again</a><br>Only <%=p %> items left</h2><br>
<%} else {%>
<h2 align="center"><a href="checkout.jsp">Try Again</a><br>Only <%=p %> item left</h2><br>
<%} %>
<%}
else
{
%>
<h1 align="center">Go To <a href="index.jsp">Home Page</a></h1>
<%} %>
<br><br><br><br><br><br>
<footer>

...
<legend align="center"><font size="6">Bank Details</font></legend>
 	<table>
            <tr>
                <td><input type="radio" name="bank">HDFC BANK</td><td><input type="radio"name="bank">ICICI BANK</td><td><input type="radio"name="bank">Alahabad Bank</td><br>
            </tr>
            <tr>
                <td><input type="radio"name="bank">State Bank Of India</td><td><input type="radio"name="bank">Kotak Bank</td><td><input type="radio"name="bank">IDBI Bank</td><br>
            </tr>
            <tr>
                <td><input type="radio"name="bank">Axix Bank</td><td><input type="radio"name="bank">Punjab National Bank</td><td><input type="radio"name="bank">Citi Bank</td><br>
            </tr>
 	</table>
 </fieldset>
